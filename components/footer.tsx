...
export function Footer() {
  return (
    <footer className="bg-[#faecc7]/95 backdrop-blurtext-background">
  ...
  />
            ...
            <div>
              ...
              <p className="text-sm mb-4">Email: hellokhushibox@gmail.com</p>
              <p className="text-sm mb-4">Phone: +91 7702522332</p>
              <div className="flex gap-4">
                ...
                <a
                  href="mailto:hellokhushibox@gmail.com"
                  className="hover:text-accent transition-colors"
                  aria-label="Email"
                >
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center text-sm opacity-70">
              <p>&copy; 2026 KHUSHIBOX. All rights reserved.</p>
